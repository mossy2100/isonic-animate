 ...
 * Description:       iSonic client's dashboard view.
 * Version:           1.0.0
 * Author:            iSonic Web Design
 * Author URI:        https://isonic.com.au/
 */
...
//         // Load your custom login page
//         include('login-page.php');
//         // Stop WordPress from loading the default login page
//         exit();
//     }    
//  }
...
//This code currently is working to link the login page, however the code on the login page isnt working. Have turned this off to be able to login to backend of animate. 
    ...
    <p style="font-weight:bold;">Recent Pages</p>
        <ul>
         <?php
            ...
            <div class="post-li">  
                <li> <a style="font-weight: 500;" href="<?php the_permalink(); ?>"><?php the_title(); ?></a> - <span style="font-style:italic;">Published on <? the_date('d/n/Y'); ?></span> <?php edit_post_link( __( 'Edit me!', 'textdomain' ), '<span>', '</span>', null, 'edit-link' );?> </li>
           </div>
          <?php endforeach; ?>
       </ol>
    ...
    <p style="font-weight:bold;">Recent Blog Posts</p>
       <ul>
         <?php
            ...
            foreach( $myposts as $post ) :  setup_postdata($post); ?>
                <div class="post-li">  
                  <li> <a style="font-weight: 500;" href="<?php the_permalink(); ?>" target="_blank;"><?php the_title(); ?></a> - <span style="font-style:italic;">Published on <? the_date('d/n/Y'); ?></span> <?php edit_post_link( __( 'Edit me!', 'textdomain' ), '<span>', '</span>', null, 'edit-link' );?></li>
                </div>
